...
module prbs23_width32_iter12_seed0 (
    input [31:0] din,
    output [31:0] dout
);

    assign dout[0] = din[6] ^ din[11];
    assign dout[1] = din[7] ^ din[12];
    assign dout[2] = din[8] ^ din[13];
    assign dout[3] = din[9] ^ din[14];
    assign dout[4] = din[10] ^ din[15];
    assign dout[5] = din[11] ^ din[16];
    assign dout[6] = din[12] ^ din[17];
    assign dout[7] = din[13] ^ din[18];
    assign dout[8] = din[14] ^ din[19];
    assign dout[9] = din[15] ^ din[20];
    assign dout[10] = din[16] ^ din[21];
    assign dout[11] = din[17] ^ din[22];
